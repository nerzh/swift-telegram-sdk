...
public struct TGSendStickerParams: Encodable {
    ...
    public init(chatId: TGChatId, sticker: TGFileInfo, disableNotification: Bool? = nil, replyToMessageId: Int? = nil, allowSendingWithoutReply: Bool? = nil, replyMarkup: TGReplyMarkup? = nil) {
            self.chatId = chatId
