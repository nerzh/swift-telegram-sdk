...
public struct TGCreateNewStickerSetParams: Encodable {
    ...
    public init(userId: Int64, name: String, title: String, pngSticker: TGFileInfo? = nil, tgsSticker: TGInputFile? = nil, webmSticker: TGInputFile? = nil, emojis: String, containsMasks: Bool? = nil, maskPosition: TGMaskPosition? = nil) {
            self.userId = userId
            self.name = name
            self.title = title
