...
extension TGBot {
    ...
    public func onCommand(_ commands: String..., filters: TGFilter = .all, options: TGCommandHandler.Options = [], botUsername: String? = nil, callback: @escaping TGHandlerCallback) {
