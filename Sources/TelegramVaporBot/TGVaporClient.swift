...
public final class TGVaporClient: TGVaporClientPrtcl {

    public typealias TGBot = TGVaporBot
    public typealias TGURI = URI
    public typealias TGMediaType = HTTPMediaType
