...
public final class Update: Codable {
    ...
    /// Optional. New poll state. TGBots receive only updates about stopped polls and polls, which are sent by the bot
    public var poll: Poll?

    /// Optional. A user changed their answer in a non-anonymous poll. TGBots receive new votes only in polls that were sent by the bot itself.
