...
/**
 This object represents a game. Use TGBotFather to create and edit games, their short names will act as unique identifiers.
...
public final class Game: Codable {
    ...
    /// Optional. Animation that will be displayed in the game message in chats. Upload via TGBotFather
