...
public extension TGBot {
    ...
    struct CopyMessageParams: Encodable {
    ...
    /**
     ...
     - Returns: EventLoopFuture of `the MessageId of the sent message` type
     */
    @discardableResult
    func copyMessage(params: CopyMessageParams) throws -> EventLoopFuture<the MessageId of the sent message> {
        let methodURL: URI = .init(string: getMethodURL("copyMessage"))
        let future: EventLoopFuture<the MessageId of the sent message> = tgClient.post(methodURL, params: params)
        return future
    }
}
