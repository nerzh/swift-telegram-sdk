...
public final class TGInputPaidMediaVideo: Codable {
    ...
    public init (type: TGInputPaidMediaVideoType, media: TGFileInfo, thumbnail: TGFileInfo? = nil, cover: TGFileInfo? = nil, startTimestamp: Int? = nil, width: Int? = nil, height: Int? = nil, duration: Int? = nil, supportsStreaming: Bool? = nil) {
        self.type = type
        self.media = media
